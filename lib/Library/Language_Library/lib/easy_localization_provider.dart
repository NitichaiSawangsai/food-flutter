...
class EasyLocalizationProvider extends InheritedWidget {
  ...
  static EasyLocalizationProvider of(BuildContext context) {
    //Discontinued -> return (context.inheritFromWidgetOfExactType(EasyLocalizationProvider) as EasyLocalizationProvider);
    return context
...
class _EasyLocalizationState extends State<EasyLocalization> {
  ...
  void changeLocale(Locale value) async {
    ...
    var _codeLang = preferences.getString('codeL') ?? 'en';
    var _codeCoun = preferences.getString('codeC') ?? 'US';
    setState(() {
  ...
  void saveLocale() async {
    ...
    var _codeLang = _preferences.getString('codeL')?? 'en';
    var _codeCoun = _preferences.getString('codeC')?? 'US';
